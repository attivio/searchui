...
In the 360&deg; View you can see the document text, extracted entities and the Insight Graph. The Insight Graph shows how this document is linked to other documents by matching the entities extracted.
